[![Run App Aaron Perkey](https://github.com/AaronPerkey/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/AaronPerkey/GithubActions/actions/workflows/run-app.yaml)
